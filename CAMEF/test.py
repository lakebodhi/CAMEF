...
if __name__ == "__main__":
    ...
    file_path = "/TRAINED/MODEL/PATH/model.pth"

    model.load_model_combined(file_path)

    avg_combined_loss, avg_mse_loss, avg_mae_loss, avg_contrastive_loss = test(model, test_loader)
    print(f'Test Combined loss: {avg_combined_loss}, Test MSE Loss: {avg_mse_loss}, Test MAE Loss: {avg_mae_loss}, Test Contrastive Loss: {avg_contrastive_loss}')
